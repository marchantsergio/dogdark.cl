...
function maxLength (max) {
  return {
    ...
    $message: ({
      $params
    }) => `La longitud máxima permitida es ${$params.max}`,
    $params: {
      max,
      type: 'maxLength'
    }
...
function sameAs (equalTo, otherName = 'other') {
  return {
    ...
    $message: ({
      $params
    }) => `El valor debe ser igual a ${otherName} valor`,
    $params: {
      equalTo,
      otherName,
      type: 'sameAs'
...
var url = {
  $validator: url$1,
  $message: 'El valor no es una dirección URL válida.',
  $params: {
    type: 'url'
  }
};
...
function or (...validators) {
  return withParams({
    type: 'or'
  }, withMessage('El valor no coincide con ninguno de los validadores proporcionados.', or$1(...validators)));
}
...
function and (...validators) {
  return withParams({
    type: 'and'
  }, withMessage('El valor no coincide con todos los validadores proporcionados', and$1(...validators)));
}
...
function not (validator) {
  return {
    ...
    $message: `El valor no coincide con el validador proporcionado`,
    $params: {
      type: 'not'
    }
  };
...
function minValue (min) {
  return {
    ...
    $message: ({
      $params
    }) => `El valor mínimo permitido es ${$params.min}`,
    $params: {
      min,
      type: 'minValue'
    }
